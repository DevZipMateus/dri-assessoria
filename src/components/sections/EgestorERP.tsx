...
const EgestorERP = () => {
  ...
  const egestorLink = "https://www.egestor.com.br/afl/15890";
    ...
    <section className="py-16 bg-background overflow-hidden">
      <div className="container px-4 mx-auto max-w-6xl">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:gap-8 lg:gap-12 mb-10">
          ...
          <div className="md:w-1/2 rounded-xl overflow-hidden shadow-xl animate-fade-in border border-border">
            <video 
        ...
        <div className="flex justify-center animate-fade-in">
          ...
          >
            <Button className="w-full py-6 bg-primary hover:bg-accent text-primary-foreground font-medium rounded-full transition-all duration-200 shadow-lg hover:shadow-xl transform hover:scale-[1.02] text-lg">
              Teste grátis
            </Button>
          </a>
        </div>
